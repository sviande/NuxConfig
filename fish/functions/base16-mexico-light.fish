...
function base16-mexico-light -d "Mexico Light"
  ...
  set color02 53/89/47 # Base 0B - Green
  set color03 f7/9a/0e # Base 0A - Yellow
  set color04 7c/af/c2 # Base 0D - Blue
  set color05 96/60/9e # Base 0E - Magenta
  set color06 4b/80/93 # Base 0C - Cyan
  ...
  set -U base16_theme mexico-light
