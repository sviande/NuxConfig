...
function base16-hopscotch -d "Hopscotch"
  ...
  set -U fish_color_autosuggestion 5c545b
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 5c545b
  ...
  set -U fish_color_selection white --bold --background=5c545b
