...
function base16-one-light -d "One Light"
  ...
  set -U fish_color_autosuggestion e5e5e6
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment e5e5e6
  ...
  set -U fish_color_selection white --bold --background=e5e5e6
