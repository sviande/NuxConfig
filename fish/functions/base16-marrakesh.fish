...
function base16-marrakesh -d "Marrakesh"
  ...
  set -U fish_color_autosuggestion 5f5b17
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 5f5b17
  ...
  set -U fish_color_selection white --bold --background=5f5b17
