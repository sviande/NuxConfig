...
function base16-material-vivid -d "Material Vivid"
  ...
  set -U fish_color_autosuggestion 323639
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 323639
  ...
  set -U fish_color_selection white --bold --background=323639
  ...
  set -U base16_theme material-vivid
