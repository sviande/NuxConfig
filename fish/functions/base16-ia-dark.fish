...
function base16-ia-dark -d "iA Dark"
  set color00 1a/1a/1a # Base 00 - Black
  set color01 d8/85/68 # Base 08 - Red
  set color02 83/a4/71 # Base 0B - Green
  set color03 b9/93/53 # Base 0A - Yellow
  set color04 8e/cc/dd # Base 0D - Blue
  set color05 b9/8e/b2 # Base 0E - Magenta
  set color06 7c/9c/ae # Base 0C - Cyan
  ...
  set color16 d8/68/68 # Base 09
  set color17 8b/6c/37 # Base 0F
  set color18 22/22/22 # Base 01
  set color19 1d/41/4d # Base 02
  ...
  set -U fish_color_autosuggestion 1d414d
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 1d414d
  ...
  set -U fish_color_selection white --bold --background=1d414d
