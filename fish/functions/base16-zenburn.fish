...
function base16-zenburn -d "Zenburn"
  ...
  set -U fish_color_autosuggestion 606060
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 606060
  ...
  set -U fish_color_selection white --bold --background=606060
