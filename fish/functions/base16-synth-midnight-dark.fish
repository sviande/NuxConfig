...
function base16-synth-midnight-dark -d "Synth Midnight Dark"
  ...
  set -U fish_color_autosuggestion 242424
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 242424
  ...
  set -U fish_color_param BFBBBF
  set -U fish_color_quote yellow #brblack
  set -U fish_color_redirection cyan
  set -U fish_color_search_match bryellow --background=242424
  set -U fish_color_selection white --bold --background=242424
